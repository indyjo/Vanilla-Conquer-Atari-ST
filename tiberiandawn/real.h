...
Map (screen) class heirarchy.
 ...
 GScreenClass (pure virtual base class) -- generic screen control
   ...
   AnimClass  ù  TemplateClass    ù        ùù FuseClass     ù    TerrainClass
              ù                   ù        ùù FlyClass      ù
              ù                   ù  BulletClass            ù
    ...
    DriveClass  InfantryClass         ùù FlyClass
         ù                      AircraftClass
   TurretClass
         ù
   TarComClass
     ...
     UnitClass
             ...
             ùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùù?
             ù                      ù            ù                 ù
       TechnoTypeClass              ù            ù                 ù
             ù                BulletTypeClass    ù                 ù
             ù                           TemplateTypeClass         ù
    ùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùùù?             TerrainTypeClass
    ù              ù           ù              ù
UnitTypeClass      ù   BuildingTypeClass      ù
                   ù                  InfantryTypeClass
           AircraftTypeClass
#endif
