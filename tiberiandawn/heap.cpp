 ...
 *                                                                                             * 
 * INPUT:   size  -- The stride of the individual sub-block ranges in this heap. This value    * 
 *                   includes the ID word that precedes each object.                           * 
 *                                                                                             * 
 * OUTPUT:  none                                                                               * 
 *                                                                                             * 
 ...
 *    allocation and freeing may occur.                                                        * 
 *                                                                                             * 
 ...
 *   02/21/1995 JLB : Created.                                                                 * 
 *=============================================================================================*/
int FixedHeapClass::Set_Heap(int count)
{
	/*
	...
	*/
	...
	/*
	**	IDs are stored as 16-bit fence/header words.
	*/
...
int FixedIHeapClass::Set_Heap(int count)
{
	Clear();
	if (FixedHeapClass::Set_Heap(count)) {
