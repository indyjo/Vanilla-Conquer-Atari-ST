...
//BG			if (LogicPage == SEENPAGE) Window_Hide_Mouse(Window);
	...
	*/
	...
	LogicPage->Blit(*LogicPage,WinX, WinY + (FontHeight+FontYSpacing), WinX, WinY, WinW, WinH - (FontHeight+FontYSpacing) );
	LogicPage->Fill_Rect(WinX,
				WinY + y,
				WinX + WinW - 1,
				WinY + WinH - 1,
				(unsigned char)WinB);
